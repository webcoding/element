  ...
  <div class="search-bar">
    <div class="searchbar">
      ...
      <label
        ...
        <span class="searchbar-text" v-text="placeholder"></span>
      </label>
    </div>
    <div class="search-list" v-show="show || currentValue">
...
//   require('ui/packages/cell/style.css');
// }

/**
 * search-bar
 * @module packages/search-bar
 * @desc 搜索框
